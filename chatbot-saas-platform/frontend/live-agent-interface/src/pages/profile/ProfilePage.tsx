        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t('profile.professionalInformationDesc')}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('profile.enablePublicProfileDesc')}
                  </p>
                </div>
                <Switch
                  checked={watch('enablePublicProfile')}
                  onCheckedChange={(checked) => setValue('enablePublicProfile', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('profile.enableSkillsDisplayDesc')}
                  </p>
                </div>
                <Switch
                  checked={watch('enableSkillsDisplay')}
                  onCheckedChange={(checked) => setValue('enableSkillsDisplay', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('profile.enableStatsDisplayDesc')}
                  </p>
                </div>
                <Switch
                  checked={watch('enableStatsDisplay')}
                  onCheckedChange={(checked) => setValue('enableStatsDisplay', checked)}
                />
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t('profile.performanceOverviewDesc')}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{agentStats?.monthlyConversations || 0}</span>
                  </div>
                  <div className="flex justify-between text-sm">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {t('profile.recentAchievementsDesc')}
              </CardDescription>
            </CardHeader>
