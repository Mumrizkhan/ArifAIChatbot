...
import { LayoutDashboard, MessageSquare, Users, BarChart3, Settings, User, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      >
        <div className="flex h-16 items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
          {branding.logo ? (
            ...
            <div className="text-xl font-bold text-gray-900 dark:text-white">{branding.companyName || "Live Agent"}</div>
          )}
